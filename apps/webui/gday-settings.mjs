...
function GdayMigration() {
  ...
  return jsxs('div', { className: 'space-y-2 border-t border-gray-200 dark:border-gray-700 pt-3', children: [
    jsx('p', { className: 'text-sm font-medium', children: 'Copy existing meetings to Gday' }),
    jsx('p', { className: 'text-xs text-gray-500', children: 'Copy recordings and existing results to your signed-in Gday account. Local files stay as a backup; this does not delete files or start transcription.' }),
    ...
    jsxs('div', { className: 'flex flex-wrap gap-3 items-center', children: [
      jsx('button', { type: 'button', className: buttonClass,
        ...
        children: running ? 'Copying meetings…' : busy ? 'Please wait…' : results.length ? 'Retry copying meetings' : 'Copy existing meetings to Gday',
      }),
