        ...
        TabView {
            Form {
                Section("Audio Sources") {
                    ...
                    Text("macOS requests microphone and screen recording permission when needed. System audio includes sound from other apps.").font(.caption).foregroundStyle(.secondary)
                }
