...
/bin/cp "$installer_assets/installer-background.tiff" "$target_dir/installer-background.tiff"
...
if ! /usr/bin/osascript "$installer_assets/open-installer.applescript" "$installer_dir" "Gday Meetings.app"; then
