...
staged_app="$installer_dir/Meeting Notes.app"
...
echo "Drag Meeting Notes.app onto Applications in the Finder window."
echo "Then open Meeting Notes from Applications to start the client and its browser UI."
